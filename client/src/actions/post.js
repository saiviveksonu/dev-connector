...
export const addPost = formData => async dispatch => {
  ...
  try {
    const res = await axios.post('http://localhost:4000/api/post/', formData,config);
...
export const addComment = (postId, formData) => async dispatch => {
  try {
    const res = await axios.post(`http://localhost:4000/api/post/comments/${postId}`, formData);
...
export const deleteComment = (postId, commentId) => async dispatch => {
  try {
    await axios.delete(`http://localhost:4000/api/post/comments/${postId}/${commentId}`);
